            ...
            <div key={i} className='cursor-pointer' >
              <Link href={item.url} passHref>
                <div className='w-96 bg-transparent h-44 lg:h-96 group-hover:h-96 relative overflow-hidden lg:mt-0 mt-5 rounded-lg hover:scale-105 duration-300 group cursor-pointer object-cover'>
                  ...
                  <div className='absolute mt-4 z-50 opacity-0 lg:opacity-100 group-hover:opacity-100 lg:-z-10 top-0 w-full group-hover:bg-gradient-to-t bg-transparent from-gray-50 to-transparent px-3 translate-y-0  py-4 group-hover:-translate-y-0 lg:group-hover:translate-y-40 duration-300'>
