...
const text = [
  {
    ...
    url: 'https://ideathings.id/blog/olimpiade-paris-2024-wujud-semangat-inklusif/'
  },
  {
    ...
    url: 'https://ideathings.id/blog/ideathings-simbol-edukasi-yg-inklusif/' 
  },
  {
          ...
          {text.map((item, i) => (
            <div key={i} className=''>
              <div
                ...
                className='w-96 bg-transparent h-96 relative overflow-hidden lg:mt-0 mt-5 rounded-lg hover:scale-105 duration-300 group cursor-pointer object-cover'
              >
